...
public class DbRepositoryProfile : Profile
{
    ...
    {
        CreateMap<Core.Entity.Agendamento, ModelDb.AgendamentoDbModel>();
        ...
        CreateMap<ModelDb.AgendamentoDbModel, Application.Model.Agendamento.AgendamentoModel>().ReverseMap();
